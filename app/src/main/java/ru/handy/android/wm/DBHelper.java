...
//			insertExitState(db, DB.LEARNING_LANGUAGE, "0");
    ...
    private void insertAllDict(SQLiteDatabase db) {
        ...
        insertDict(db, "acacia", "[ə'kei∫ə]", "акация", "деревья");
        insertDict(db, "alder", "['o:ldə]", "ольха", "деревья");
        insertDict(db, "apple tree", "['æpl tri:]", "яблоня", "деревья");
        insertDict(db, "ash", "[æ∫]", "ясень", "деревья");
        insertDict(db, "aspen", "['æspən]", "осина", "деревья");
        insertDict(db, "baobab", "['beiəubæb]", "баобаб", "деревья");
        insertDict(db, "bay", "[bei]", "лавр", "деревья");
        insertDict(db, "beech", "[bi:t∫]", "бук", "деревья");
        insertDict(db, "birch", "[bε:t∫]", "берёза", "деревья");
        insertDict(db, "cedar", "['si:də]", "кедр", "деревья");
        insertDict(db, "chestnut", "['t∫esnʌt]", "каштан", "деревья");
        insertDict(db, "elm", "[elm]", "вяз", "деревья");
        insertDict(db, "eucalyptus", "[ju:kə'liptəs]", "эвкалипт", "деревья");
        insertDict(db, "fir", "[fε:]", "пихта", "деревья");
        insertDict(db, "hazel", "['heizəl]", "орешник", "деревья");
        insertDict(db, "juniper", "['dʒu:nipə]", "можжевельник", "деревья");
        insertDict(db, "larch", "[la:t∫]", "лиственница", "деревья");
        insertDict(db, "lilac", "['lailək]", "сирень", "деревья");
        insertDict(db, "linden", "['lindən]", "липа", "деревья");
        insertDict(db, "maple", "['meipl]", "клён", "деревья");
        insertDict(db, "oak", "[əuk]", "дуб", "деревья");
        insertDict(db, "palm", "[pa:m]", "пальма", "деревья");
        insertDict(db, "pear tree", "[pεə tri:]", "груша", "деревья");
        insertDict(db, "pine", "[pain]", "сосна", "деревья");
        insertDict(db, "plum tree", "['plʌm tri:]", "слива", "деревья");
        insertDict(db, "poplar", "['poplə]", "тополь", "деревья");
        insertDict(db, "sequoia", "[si'kwoiə]", "секвойя", "деревья");
        insertDict(db, "spruce", "[spru:s]", "ель", "деревья");
        insertDict(db, "walnut", "['wo:lnʌt]", "грецкий орех", "деревья");
        insertDict(db, "willow", "['wiləu]", "ива", "деревья");
        insertDict(db, "yew tree", "['ju: tri:]", "тис", "деревья");
        ...
        insertDict(db, "calculate", "[ˈkælkjʊleɪt]", "считать", "математика");
        ...
        insertDict(db, "blow, blew, blown", "[bloʊ, blu:, blu:]", "дуть", "неправильные глаголы a-c");
        ...
        insertDict(db, "choose, chose, chosen", "[tʃu:z, tʃoʊz, tʃoʊzn]", "выбирать", "неправильные глаголы a-c");
        ...
        insertDict(db, "forget, forgot, forgotten", "[fəˈget, fəˈgɒt, fəˈgɒtn]", "забыть", "неправильные глаголы d-f");
        ...
        insertDict(db, "go, went, gone", "[goʊ, wɛnt, ɡɒn]", "ходить", "неправильные глаголы g-k");
        ...
        insertDict(db, "know, knew, known", "[noʊ, nju:, noʊn]", "знать", "неправильные глаголы g-k");
        ...
        insertDict(db, "mean, meant, meant", "[mi:n, mɛnt, mɛnt]", "означать", "неправильные глаголы r-l");
        insertDict(db, "meet, met, met", "[mi:t, mɛt, mɛt]", "встретить", "неправильные глаголы r-l");
        insertDict(db, "mistake, mistook, mistaken", "[mɪisˈteɪk, mɪˈstʊk, mɪˈsteɪk(ə)n]", "ошибаться", "неправильные глаголы r-l");
        ...
        insertDict(db, "prove, proved, proven", "[pru:v, pru:vd, pru:vən]", "доказывать", "неправильные глаголы r-l");
        insertDict(db, "put, put, put", "[pʊt, pʊt, pʊt]", "класть", "неправильные глаголы r-l");
        insertDict(db, "read, read, read", "[ri:d, rɛd, rɛd]", "читать", "неправильные глаголы r-l");
        ...
        insertDict(db, "say, said, said", "[sɛɪ, sɛd, sɛd]", "сказать", "неправильные глаголы s1");
        ...
        insertDict(db, "speak, spoke, spoken", "[spi:k, spoʊk, spoʊkən]", "разговаривать", "неправильные глаголы s2");
        ...
        insertDict(db, "tell, told, told", "[tel, toʊld, toʊld]", "рассказать", "неправильные глаголы t-w");
        insertDict(db, "think, thought, thought", "[θɪŋk, θɔ:t, θɔ:t]", "думать", "неправильные глаголы t-w");
        ...
        insertDict(db, "understand, understood, understood", "[ʌndəˈstænd, ʌndəˈstʊd, ʌndəˈstʊd]", "понимать, понять", "неправильные глаголы t-w");
        ...
        insertDict(db, "stomatologist", "Stomatologist", "стоматолог", "профессии4");
        ...
        insertDict(db, "hear", "[hɪə]", "слышать", "прочее1");
        insertDict(db, "left", "[left]", "левый", "прочее1");
        insertDict(db, "phone", "[fəʊn]", "телефон", "прочее1");
        insertDict(db, "right", "[raɪt]", "правый", "прочее1");
        insertDict(db, "see", "[siː]", "видеть", "прочее1");
        insertDict(db, "show", "[ʃəʊ]", "показывать", "прочее1");
        insertDict(db, "sing", "[sɪŋ]", "петь", "прочее1");
        insertDict(db, "sleep", "[sliːp]", "спать", "прочее1");
        insertDict(db, "stamp", "[stæmp]", "топать", "прочее1");
        insertDict(db, "swim", "[swɪm]", "плавать", "прочее1");
        insertDict(db, "talk", "[tɔːk]", "разговаривать", "прочее1");
        ...
        insertDict(db, "write", "[raɪt]", "писать", "прочее1");
        ...
        insertDict(db, "acknowledge", "[əkˈnɔlɪʤ]", "признавать, осознать", "прочее12");
        insertDict(db, "amateur", "[ˈæmətə:]", "любительский, любитель", "прочее12");
        insertDict(db, "assume", "[ə'sju:m]", "предполагать, принимать", "прочее12");
        ...
        insertDict(db, "spoil", "[spɔːɪl]", "портить, баловать", "прочее13");
        ...
        insertDict(db, "confuse", "[kənˈfjuːz]", "путать, смущать", "прочее14");
        ...
        insertDict(db, "determine", "[dɪˈtɜːmɪn]", "определить, определение", "прочее19");
        ...
        insertDict(db, "behave", "[bɪˈheɪv]", "вести себя", "прочее2");
        insertDict(db, "cry", "[kraɪ]", "плакать", "прочее2");
        insertDict(db, "feel", "[fiːl]", "чувствовать", "прочее2");
        insertDict(db, "friend", "[frend]", "друг", "прочее2");
        insertDict(db, "go", "[gəʊ]", "ходить", "прочее2");
        insertDict(db, "hug", "[hʌg]", "обнять", "прочее2");
        insertDict(db, "know", "[nəʊ]", "знать", "прочее2");
        insertDict(db, "look", "[lʊk]", "смотреть", "прочее2");
        insertDict(db, "next to", "[nekst tuː]", "рядом", "прочее2");
        insertDict(db, "really", "[ˈrɪəlɪ]", "действительно", "прочее2");
        insertDict(db, "say", "[seɪ]", "сказать", "прочее2");
        insertDict(db, "scared", "[skɛəd]", "испуганный, бояться", "прочее2");
        insertDict(db, "tell", "[tel]", "рассказать", "прочее2");
        insertDict(db, "together", "[təˈgeðə]", "вместе", "прочее2");
        insertDict(db, "want", "[wɔnt]", "хотеть", "прочее2");
        ...
        insertDict(db, "doubt", "[daut]", "сомневаться", "прочее20");
        ...
        insertDict(db, "withdraw", "[wɪðˈdrɔː]", "выйти, уйти, отказаться", "прочее22");
        ...
        insertDict(db, "overcome", "[əʊvəˈkʌm]", "преодолеть", "прочее23");
        ...
        insertDict(db, "withstand", "[wɪðˈstænd]", "выдержать, противостоять", "прочее23");
        ...
        insertDict(db, "plane", "[pleɪn]", "самолет", "транспорт, путешествие1");
        ...
        insertDict(db, "answer", "[ˈɑːnsə]", "ответ, отвечать", "учеба");
        insertDict(db, "ask", "[ɑːsk]", "спрашивать", "учеба");
        ...
        insertDict(db, "run into", "[rʌn əˈweɪ]", "столкнуться, наскочить", "фразовые глаголы r-s");
        ...
        insertDict(db, "bird cherry", "[bɜːd ˈʧerɪ]", "черемуха", "ягоды");
        insertDict(db, "blackberry", "[ˈblækbərɪ]", "ежевика", "ягоды");
        insertDict(db, "blackcurrant", "[blækˈkʌrənt]", "черная смородина", "ягоды");
        insertDict(db, "blueberry", "[ˈbluːberɪ]", "черника", "ягоды");
        insertDict(db, "cherry", "[ˈʧerɪ]", "вишня", "ягоды");
        insertDict(db, "chokeberry", "[ˈʧəʊkbərɪ]", "черноплодная рябина", "ягоды");
        insertDict(db, "cowberry", "[ˈkaʊbərɪ]", "брусника", "ягоды");
        insertDict(db, "cranberry", "[ˈkrænbərɪ]", "клюква", "ягоды");
        insertDict(db, "gooseberry", "[ˈgʊzbərɪ]", "крыжовник", "ягоды");
        insertDict(db, "melon", "[ˈmelən]", "дыня", "ягоды");
        insertDict(db, "raspberry", "[ˈrɑːzbərɪ]", "малина", "ягоды");
        insertDict(db, "redcurrant", "[ˈredkʌrənt]", "красная смородина", "ягоды");
        insertDict(db, "rosehip", "[ˈrəʊzɪp]", "шиповник", "ягоды");
        insertDict(db, "strawberry", "[ˈstrɔːbərɪ]", "земляника", "ягоды");
        insertDict(db, "watermelon", "[ˈwɔːtəmelən]", "арбуз", "ягоды");
        insertDict(db, "rowan", "[ˈraʊən]", "рябина", "ягоды, деревья");
    }

    // заполняем основную таблицу-словарь при переходе из версии 13
    private void updateDictFrom13(SQLiteDatabase db) {
        db.execSQL(DB.T_STATISTICS_CREATE);
        ContentValues cv = new ContentValues();
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈsɪlɪ]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='silly'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_TRANSCRIPTION, "[əˈtentɪv]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='attentive'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "транспорт, насекомые");
        cv.put(DB.C_EW_RUSTRANSLATE, "летать, муха");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='fly'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "ягоды, деревья");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='rowan'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "страны азии");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_CATEGORY + "='страны азия'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "страны америки");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_CATEGORY + "='страны америка'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "страны африки");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_CATEGORY + "='страны африка'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "страны европы");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_CATEGORY + "='страны европа'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "English");
        cv.put(DB.C_EW_CATEGORY, "учеба1, прилагательные стран европы");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='english'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "Russian");
        cv.put(DB.C_EW_CATEGORY, "учеба1, прилагательные стран европы, жители европы");
        cv.put(DB.C_EW_RUSTRANSLATE, "русский, русская");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='russian'", null);
        insertDict(db, "acacia", "[ə'kei∫ə]", "акация", "деревья");
        insertDict(db, "alder", "['o:ldə]", "ольха", "деревья");
        insertDict(db, "apple tree", "['æpl tri:]", "яблоня", "деревья");
        insertDict(db, "ash", "[æ∫]", "ясень", "деревья");
    ...
    // заполняем основную таблицу-словарь при переходе из версии 16
    private void updateDictFrom16(SQLiteDatabase db) {
        insertExitState(db, DB.LEARNING_TYPE, "0");
        ContentValues cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "география, путешествие1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='city'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "география, путешествие2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='border'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "география, путешествие2");
        cv.put(DB.C_EW_RUSTRANSLATE, "страна, сельская местность");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='country'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "геометрия, прилагательные основные3");
        cv.put(DB.C_EW_RUSTRANSLATE, "овал, овальный");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='oval'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "геометрия, прилагательные основные3");
        cv.put(DB.C_EW_RUSTRANSLATE, "квадрат, квадратный");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='square'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "геометрия, учеба1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='circle'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные времени1, предлоги1");
        cv.put(DB.C_EW_RUSTRANSLATE, "следующий, рядом, около");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='next'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные основные1, предлоги2");
        cv.put(DB.C_EW_RUSTRANSLATE, "близкий, около, возле");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='near'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные состояния1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='mature'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные состояния1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='thirsty'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные эмоций1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='upset'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные эмоций3");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='angry'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='show'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='sleep'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='stamp'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='swim'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='talk'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='cry'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='go'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='hug'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='know'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='look'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='love'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='next to'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='our'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='say'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='tell'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прочее2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='want'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "путешествие1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='depart'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "учеба2, математика");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='mathematics'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы c-f");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='carry on'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы c-f");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='carry out'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы c-f");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='count on'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы c-f");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='fed up'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы c-f");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='fill out'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы c-f");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='find out'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы g");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='get stuck'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы g");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='give up'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы h-l");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='look forward to'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы m-p");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='pull up'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы t-w");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='take up'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "фразовые глаголы t-w");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='turn out'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "математика");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='proof'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "геометрия");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='dimension'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги1");
        cv.put(DB.C_EW_RUSTRANSLATE, "между, среди");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='among'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='behind'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='besides'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='between'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='despite'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='in front of'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги1");
        cv.put(DB.C_EW_RUSTRANSLATE, "до, до тех пор, пока");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='until'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "предлоги1");
        cv.put(DB.C_EW_RUSTRANSLATE, "против, в сравнении с (чем-л.)");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='versus'", null);
        insertDict(db, "maths", "[mæθs]", "математика", "математика");
        insertDict(db, "addition", "[əˈdɪʃn]", "прибавление", "математика");
        insertDict(db, "subtraction", "[səbˈtrækʃn]", "вычитание", "математика");
        insertDict(db, "multiplication", "[mʌltɪplɪˈkeɪʃn]", "умножение", "математика");
        insertDict(db, "division", "[dɪˈvɪʒən]", "деление", "математика");
    ...
    // заполняем основную таблицу-словарь при переходе из версии 17
    private void updateDictFrom17(SQLiteDatabase db) {
        // в таблице с текущим уроком добавляем 2 столбца для комплексного обучения и изменяем наим-е столбца с порядковым номером слова
        db.execSQL("ALTER TABLE " + DB.T_LESSON + " RENAME TO lesson_old");
        db.execSQL(DB.T_LESSON_CREATE);
        db.execSQL("INSERT INTO " + DB.T_LESSON + " (" + DB.C_L_ID + ", " + DB.C_L_ENGWORD_ID + ", "
                + DB.C_L_ENGWORD + ", " + DB.C_L_TRANSCRIPTION + ", " + DB.C_L_RUSTRANSLATE + ", "
                + DB.C_L_CATEGORY + ", " + DB.C_L_RESULT + ", " + DB.C_L_ORDINAL
                + ") SELECT " + DB.C_L_ID + ", " + DB.C_L_ENGWORD_ID + ", " + DB.C_L_ENGWORD + ", "
                + DB.C_L_TRANSCRIPTION + ", " + DB.C_L_RUSTRANSLATE + ", " + DB.C_L_CATEGORY + ", "
                + DB.C_L_RESULT + ", l_is_current FROM lesson_old");
        db.execSQL("DROP TABLE lesson_old");
        // все остальные действия
        insertExitState(db, DB.LEARNING_SPEAK, "1");
        insertExitState(db, DB.LEARNING_REPEATS_AMOUNT, "2");
        ContentValues cv = new ContentValues();
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈsʌnbɜːnt]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='sunburnt'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈʌnˈlaɪk]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='unlike'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_RUSTRANSLATE, "закономерный, регулярный");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='regular'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='again'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='always'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='sometimes'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='urgently'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "транспорт, профессии4");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='driver'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "учеба, профессии5");
        cv.put(DB.C_EW_RUSTRANSLATE, "учитель, преподаватель, воспитатель");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='teacher'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "учеба");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_CATEGORY + "='учеба1'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "учеба");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_CATEGORY + "='учеба2'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "учеба, прилагательные кач-ва и кол-ва1");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='correct'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные стран европы");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='English'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "прилагательные стран европы, жители европы");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='Russian'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "учеба, математика");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='mathematics'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "геометрия, учеба");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='circle'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='fortnight'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='rarely'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "время2");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='afterwards'", null);
        db.delete(DB.T_ENGWORDS, DB.C_EW_ENGWORD + "='maths'", null);
        insertDict(db, "April", "['eipr(ə)l]", "апрель", "время1");
        insertDict(db, "August", "[ɔːˈgʌst]", "август", "время1");
        insertDict(db, "century", "[ˈsenʧʊrɪ]", "век", "время1");
        insertDict(db, "day", "[deɪ]", "день", "время1");
        ...
        insertDict(db, "chemist", "['kemıst]", "химик", "профессии3");
        insertDict(db, "conductor", "[kən'dʌktə]", "дирижер", "профессии3");
        insertDict(db, "cosmonaut", "['speısmæn]", "космонавт", "профессии3");
        insertDict(db, "dermatologist", "[,də:mə'tɔləʤıst]", "дерматолог", "профессии3");
        insertDict(db, "dog expert", "[dɔg'ekspə:t]", "кинолог", "профессии3");
        insertDict(db, "electrician", "[ılek'trıʃən]", "электрик", "профессии3");
        insertDict(db, "expert", "['ekspə:t]", "специалист, эксперт", "профессии3");
    ...
    // заполняем основную таблицу-словарь при переходе из версии 18
    private void updateDictFrom18(SQLiteDatabase db) {
        insertExitState(db, DB.LEARNING_SHOW_DONTKNOW, "1");
        // в связи с тем, что в БД в транскрипции меняем 0 на 1, само значение также меняем на противоположное
        String trancr = "";
        try {
            Cursor c = db.query(DB.T_EXITSTATE, null, DB.C_ES_VARIABLE + "="
                    + DB.LEARNING_SHOW_TRANSCR, null, null, null, null);
            if (c != null) {
                if (c.moveToFirst()) {
                    trancr = c.getString(c.getColumnIndex(DB.C_ES_VALUE));
                }
                c.close();
            }
        } catch (Exception ex) {
        ...
        ContentValues cv = new ContentValues();
        cv.put(DB.C_ES_VALUE, isShowTrancr ? "0" : "1");
        db.update(DB.T_EXITSTATE, cv, DB.C_ES_VARIABLE + "='" + DB.LEARNING_SHOW_TRANSCR + "'", null);

        insertExitState(db, DB.PRONUNCIATION_USUK, "0");
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "catfish");
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈsɪlɪ]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='channel catfish'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "perch");
        cv.put(DB.C_EW_TRANSCRIPTION, "[pə:tʃ]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='common bass'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "sea eel");
        cv.put(DB.C_EW_TRANSCRIPTION, "[siː ʹi:l]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='conger eel'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "crucian");
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈkruːʃən]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='crucian carp'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "tuna");
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈtu:nə]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='frigate mackerel'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_RUSTRANSLATE, "щука");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='pike'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "sardine");
        cv.put(DB.C_EW_TRANSCRIPTION, "[sɑːˈdiːn]");
        cv.put(DB.C_EW_RUSTRANSLATE, "сардина");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='pilchard'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "salmon");
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈsæmən]");
        cv.put(DB.C_EW_RUSTRANSLATE, "семга");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='pink salmon'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "sea bass");
        cv.put(DB.C_EW_TRANSCRIPTION, "[siː bæs]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='rockfish'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "flounder");
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈflaundə]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='turbot brill'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "hake");
        cv.put(DB.C_EW_TRANSCRIPTION, "[heɪk]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='whiting'", null);
        db.delete(DB.T_ENGWORDS, DB.C_EW_ENGWORD + "='goldfish'", null);
    }

    // заполняем основную таблицу-словарь при переходе из версии 19
    private void updateDictFrom19(SQLiteDatabase db) {
        ContentValues cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "armchair");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='armchear'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "modern");
        cv.put(DB.C_EW_TRANSCRIPTION, "[ˈməʊdern]");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='modem'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_ENGWORD, "washing machine");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='washing mashine'", null);
        db.delete(DB.T_ENGWORDS, DB.C_EW_ENGWORD + "='our'", null);
        insertDict(db, "he", "[hiː]", "он", "местоимения");
        insertDict(db, "her", "[hɜː, hɜːz]", "ее", "местоимения");
        insertDict(db, "herself", "herself", "сама", "местоимения");
        insertDict(db, "himself", "[hɪmˈself]", "сам", "местоимения");
        insertDict(db, "his", "[hɪz]", "его", "местоимения");
        insertDict(db, "I", "[aɪ]", "я", "местоимения");
        insertDict(db, "it", "[ɪt]", "оно", "местоимения");
        ...
        insertDict(db, "myself", "[maɪˈself]", "сам, сама (я)", "местоимения");
        insertDict(db, "our, ours", "[‘auə, ‘auəz]", "наш", "местоимения");
        insertDict(db, "ourselves", "ourselves", "сами (мы)", "местоимения");
        insertDict(db, "she", "[ʃiː]", "она", "местоимения");
        insertDict(db, "that", "[ðæt]", "тот, та, то", "местоимения");
        insertDict(db, "their, theirs", "[ðeə, ðeəz]", "их", "местоимения");
        insertDict(db, "themselves", "[ðəmˈselvz]", "сами (они)", "местоимения");
    ...
    // заполняем основную таблицу-словарь при переходе из версии 20
    private void updateDictFrom20(SQLiteDatabase db) {
        ContentValues cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "погода, космос");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='sun'", null);
        cv = new ContentValues();
        cv.put(DB.C_EW_CATEGORY, "профессии3, космос");
        db.update(DB.T_ENGWORDS, cv, DB.C_EW_ENGWORD + "='cosmonaut'", null);
        insertDict(db, "asteroid", "[ˈæstərɔɪd]", "астероид", "космос");
        insertDict(db, "Venus", "[ˈvi:nəs]", "Венера", "космос");
        insertDict(db, "universe", "[ˈju:nɪvɜ:rs]", "вселенная", "космос");
        insertDict(db, "galaxy", "[ˈɡæləksɪ]", "галактика", "космос");
